...
import { drawEdge, drawMessageFlow, drawAssociation } from './edges.js';
  ...
  if (element.type === 'label') {
    ...
    if (labelTarget) {
      ...
      if (targetType === 'task' || targetType === 'subprocess-expanded' ||
          ...
          targetType === 'dataobject' || targetType === 'group') {
...
BeatRenderer.prototype.drawConnection = function(parentNode, element) {
  ...
  if (type === 'messageflow') return drawMessageFlow(parentNode, element);
